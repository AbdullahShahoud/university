...
mixin _$FavoritesState {
  List<FavoriteStartup> get favorites => throw _privateConstructorUsedError;
...
abstract class $FavoritesStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({
    List<FavoriteStartup> favorites,
    bool isLoading,
    String? errorMessage,
  });
}
...
class _$FavoritesStateImpl implements _FavoritesState {
  const _$FavoritesStateImpl({
    final List<FavoriteStartup> favorites = const [],
    this.isLoading = false,
    this.errorMessage,
  }) : _favorites = favorites;

  final List<FavoriteStartup> _favorites;
  @override
  @JsonKey()
  List<FavoriteStartup> get favorites {
...
abstract class _FavoritesState implements FavoritesState {
  const factory _FavoritesState({
    final List<FavoriteStartup> favorites,
    final bool isLoading,
    final String? errorMessage,
  }) = _$FavoritesStateImpl;
